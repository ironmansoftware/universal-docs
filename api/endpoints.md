...
APIs that you create will automatically be added to the OpenAPI documentation that is generated by PowerShell Universal. You can access the Swagger documentation page by navigating to Security \ Tokens and clicking API Documentation.&#x20;

Next, select the Endpoints definition to see endpoints.&#x20;

<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption></figcaption></figure>

All your custom endpoints will be listed.

![Swagger Documentation for APIs](<../.gitbook/assets/image (313) (1).png>)
...
![Swagger Documentation for an API](<../.gitbook/assets/image (315).png>)
...
{% hint style="info" %}
Currently, you will need to use the configuration editor in Settings \ Configurations \ .universal \ endpoints.ps1 to define the classes.&#x20;
{% endhint %}
