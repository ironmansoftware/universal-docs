...
<figure><img src="../.gitbook/assets/image (3) (1) (1) (1).png" alt=""><figcaption><p>Edit Page Button</p></figcaption></figure>

### Adding Widgets

To add an UI element to the page, click Add Widget to select from a list of Widgets to add to the page.

<figure><img src="../.gitbook/assets/image (4) (1) (1).png" alt=""><figcaption><p>Adding a Portal Widget.</p></figcaption></figure>
